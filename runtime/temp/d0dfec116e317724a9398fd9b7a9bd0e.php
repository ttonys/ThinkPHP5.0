<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\WAMP\www\tp5\public/../application/admin\view\article\edit.html";i:1547903699;s:54:"D:\WAMP\www\tp5\application\admin\view\common\top.html";i:1547806501;s:55:"D:\WAMP\www\tp5\application\admin\view\common\left.html";i:1547788931;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title"
                                                       value="<?php echo $articles['title']; ?>" type="text">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author" placeholder="" name="author"
                                                       value="<?php echo $articles['author']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="keywords" placeholder="" name="keywords"
                                                       value="<?php echo $articles['keywords']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="desc" class="form-control"><?php echo $articles['intro']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                <input id="pic" placeholder="" name="pic" style="display:inline;"
                                                       type="file">
                                                <?php if($articles['pic'] != ''): ?>
                                                <img src="http://127.0.0.1/tp5/public/static<?php echo $articles['pic']; ?>" height="50">
                                                <?php else: ?>
                                                <span>暂无缩略图</span>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="cateid">
                                                    ...
                                                    <option {if condition="$vo['id'] eq $articles['cateid']"
                                                            }selected="selected" {
                                                    /if} value="<?php echo $vo['id']; ?>"><?php echo $vo['catename']; ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填
                                            <div>
                                            </p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input <?php if($articles['state'] == 1): ?>checked="checked" <?php endif; ?>
                                                    class="checkbox-slider colored-darkorange" name="state"
                                                    type="checkbox">
