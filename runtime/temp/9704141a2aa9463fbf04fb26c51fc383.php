<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\WAMP\www\tp5\public/../application/admin\view\cate\update.html";i:1547790704;s:55:"D:\WAMP\www\tp5\application\admin\view\common\left.html";i:1547788931;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">修改名称</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="group_id" class="col-sm-2 control-label no-padding-right">新名称</label>
                                            <div class="col-sm-6">
